...
if(SITE_ID == 's2'){
    if(in_array('s1', $arBrendElem['SITE_ID']) && !in_array('s2', $arBrendElem['SITE_ID'])){
        LocalRedirect("https://bh.by".$arBrendElem['BREND']['DETAIL_PAGE_URL']);
    }
}
            ...
            <div id="MY_AJAX_FILTER">
                ...
                <?if (!isset($_REQUEST['no_serii']) && $_REQUEST['no_serii'] != 'Y'):?>
                    ...
                    if(empty($arBrendElem['SER_ID'])){
                        ...
                        LocalRedirect($APPLICATION->GetCurPage().'?no_serii=Y');
                ...
                <?if(isset($_REQUEST['set_filter']) && !empty($_REQUEST['set_filter']) && $_REQUEST['set_filter'] == 'Показать'){
                    if(!isset($_REQUEST['no_serii']) && empty($_REQUEST['no_serii'])){
                        LocalRedirect($APPLICATION->GetCurPageParam('no_serii=Y'));
                    }
                }?>
