...
if ($arParams['SHOW_ACCOUNT_COMPONENT'] !== 'N')
{
    ?>
    <style>
        .sale-personal-account-wallet-container .sale-personal-account-wallet-list-container{
            background-color: darkgray;
        }
        .sale-personal-account-wallet-container .sale-personal-account-wallet-title{
