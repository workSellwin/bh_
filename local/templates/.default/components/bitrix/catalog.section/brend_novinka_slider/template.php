...
<?if($arParams['SLIDER_NUM'] < 10 && count($arResult['ITEMS']) > 0):?>
    ...
    <div style="cursor: pointer;" class="main__ttl" onclick="location='<?=$arParams['arBrendElem']['BREND']['DETAIL_PAGE_URL'].$arParams['arBrendElem']['SERII_CODE'][$arParams['key']]?>/'"><?= $arParams['arBrendElem']['SER_ID'][$arParams['key']] ?></div>
<?endif;?>
...
<div class="product__list brend-novinki-slider-container-<?=$arParams['SLIDER_NUM']?>" data-entity="<?= $containerName ?>">
    <?
